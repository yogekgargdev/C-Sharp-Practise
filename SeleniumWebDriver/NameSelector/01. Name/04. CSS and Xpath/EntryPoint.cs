...
class EntryPoint
{
    static void Main()
    {
        ...
        String Css_Path = "body > article > div.container-fluid.px-0 > div > div > div > div > h1";
        String xpath_element = "/html/body/article/div[2]/div/div/div/div/h1";
        IWebDriver driver = new ChromeDriver();
        driver.Navigate().GoToUrl(url);

        IWebElement element_csspath = driver.FindElement(By.CssSelector(Css_Path)); //-> This element is basically the top heading
